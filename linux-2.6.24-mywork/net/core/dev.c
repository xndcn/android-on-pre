...
int register_netdevice(struct net_device *dev)
{
	...
	//printk("It's register_netdevice\n");
	...
	//printk("before netdev_set_lockdep\n");
	...
	//printk("before dev_init_scheduler.\n");
